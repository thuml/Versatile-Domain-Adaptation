...
class ResNetFc(nn.Module):
  def __init__(self, resnet_name, use_bottleneck=True, bottleneck_dim=1024, new_cls=False, class_num=1000):
...
class LambdaNet(nn.Module):
  def __init__(self, in_feature):
    ...
    self.ad_layer1 = nn.Linear(in_feature, 31)
    self.ad_layer1.weight.data.normal_(0, 0.3)
